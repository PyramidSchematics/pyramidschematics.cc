...
That way we have RAM, a ROM, and a Versatile Adaptor Interface (VIA) to be able to perform I/O operations when all the data and address lines are already in use.
